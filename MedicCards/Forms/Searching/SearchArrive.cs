...
{
    public partial class SearchArrive : Form
    {
        private sbyte row;
        ...
        private void SearchArrive_Load(object sender, EventArgs e)
        {
            dataGridView1.Rows.Clear();
            if (Values.getIsFirstForArrive())
            {
                Placing();
            ...
            else
            {
                ...
                new Change().Add(dataGridView1, date, "Дата_поступления");
                count.Text = "Количество: " + dataGridView1.Rows.Count.ToString();
                Values.setIsFirstForArrive(true);
            }
        }

        private void search_Click(object sender, EventArgs e)
        {
            Values.setIsFirstForArrive(false);
            new Change().Add(dataGridView1, date, "Дата_поступления");
            count.Text = "Количество: " + dataGridView1.Rows.Count.ToString();
        }
        ...
        private void SearchArrive_ClientSizeChanged(object sender, EventArgs e)
        {
            Placing();
        }
        ...
        private void SearchArrive_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
    }
