...
{
    public partial class SearchBirth : Form
    {
        private sbyte row;
        ...
        private void SearchBirth_Load(object sender, EventArgs e)
        {
            dataGridView1.Rows.Clear();
            if (Values.getIsFirstForBirth())
            {
                Placing();
            }
            else
            {
                ...
                new Change().Add(dataGridView1, date, "Дата_рождения");
                count.Text = "Количество: " + dataGridView1.Rows.Count.ToString();
                Values.setIsFirstForBirth(true);
            }
        }

        private void search_Click(object sender, EventArgs e)
        {
            Values.setIsFirstForBirth(false);
            new Change().Add(dataGridView1, date, "Дата_рождения");
            count.Text = "Количество: " + dataGridView1.Rows.Count.ToString();
        }
        ...
        private void SearchBirth_ClientSizeChanged(object sender, EventArgs e)
        {
            Placing();
        }
        ...
        private void SearchBirth_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
    }
